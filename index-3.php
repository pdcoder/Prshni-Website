...
$sql2 = "SELECT * FROM productlist LIMIT 4";
$result2 = $conn->query($sql2);
$sql3 = "SELECT * FROM stats LIMIT 1";
$result3 = $conn->query($sql3);
$sql4 = "SELECT * FROM featured LIMIT 1";
...
<style>
.home-about-area:after{position:absolute;content:"";top:0;right:0;width:48%;height:100%;background:url() no-repeat center center/cover;z-index:1}@media (max-width: 991px){.home-about-area:after{display:none}}@media (max-width: 991px){.home-about-area .justify-content-end{justify-content:flex-start !important}}.home-about-area h1{margin-bottom:20px}.home-about-area .home-about-right{max-width:580px;padding-right:36px}@media (max-width: 1024px){.home-about-area .home-about-right{padding-left:15px}}

.head {
      background:rgba(0,0,0,0.9);   /* for latest browsers */
}
.marquee {
    width: 100%;
	line-height: 10vh;
	background-color: #4D4C78;
	color: white;
    white-space: nowrap;
    overflow: hidden;
			  ...
			  <header id="header" id="home">
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.php"><img src="img/logo.png" alt="Prshni" title="Prshni" style="width:auto;height:40px;"/></a>
				      </div>
...
?>
			<!-- start banner Area -->
				...
				<div class="item">
				  <div class="img-fill">
					<img src="<?php echo substr($row['pic'],1); ?>" alt="" style="width:100%;height:auto;">
					<div class="info">
					  <div>
...
<br>
			...
			<!-- End service Area -->
			<div class="fp"><div class="scroll-animations">
					<div class="animated"><h2>FEATURED PRODUCT</h2>
					</div>
			</div>

<div class="row" id="fprow" style="background:#f6f6f6; text-align:center;">
			<?php

       while($row4 = $result4->fetch_assoc()) {
      
?>
    	<a style="color:grey;margin:0 auto;" href="product.php?id1=<?php echo $row4['id'];?>" >

<div class="row" id="row1">
	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		<img src="img/b1.jpg" alt="img"  style="width:100%;height:auto;" id="fpd"> 
	</div>
	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">

	<h3 id="h3" style="color:#818080"><?php echo $row4['imgname']; ?></h3>
											<br><br>
	<p><?php echo $row4['imagdes'];?></p>
	 </div>
...
<div class="scroll-animations"><div class="animated">
			<div class="fp"><h2>MORE PRODUCTS</h2></div></div>
</div>
...
<!-- End testomial Area -->	
<div class="fp"><div class="scroll-animations">
<div class="animated"><h2>OUR REACH</h2></div></div><!-- Start fact Area -->
...
?>
	  ...
	  <h1><div style="color:#818080;" class="counter" data-count="<?php echo $row3['orders'] ; ?>">0</div></h1>
        <p style="color:#818080;">COMPLETED ORDERS</p>
      </div>
      <div class="col-lg-4 col-md-6 single-fact">
	  <h1><div style="color:#818080;" class="counter" data-count="<?php echo $row3['clients'] ; ?>">0</div></h1>
        <p style="color:#818080;">HAPPY CLIENTS</p>
      </div>
      <div class="col-lg-4 col-md-6 single-fact">
	  <h1><div style="color:#818080;" class="counter" data-count="<?php echo $row3['sold'] ; ?>">0</div></h1>
        <p style="color:#818080;">PRODUCTS SOLD</p>
      </div>	
	   <?php
	}
}
...
<div class="fp"><div class="scroll-animations">
<div class="animated"><h2>ORDER HERE</h2></div></div>
			...
			<section class="faq-area section-gap">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-md-12 pb-50 header-text text-center">
						<div class="fp"><div class="scroll-animations">
<div class="animated"><h2>FREQUENTYLY ASKED QUESTIONS</h2></div></div>							
						</div>
					</div>			
						...
						<div class="col-lg-8 faq-left">
		                    <div class="mn-accordion" id="accordion">
		                        ...
		                        <div class="accordion-item">
		                            <div class="accordion-heading" style="background-color:#214565">
		                                <h3 style="color:white;">What are our Products?</h3>
		                                <div class="icon">
		                                    <i class="lnr lnr-chevron-right"></i>
		                                </div>
		                            </div>
		                            <div class="accordion-content">
		                                <p>Our in houses products ranges across a vast section inclucing Fire alarm , Water Level Controller , Air Purifer ,Home Automation , Gas Sensor.</p>
		                            </div>
		                        </div>
		                        <!--Accordion item-->
		                        ...
		                        <div class="accordion-item">
		                            ...
		                            <div class="accordion-content">
		                                <p>We are a product manufacturing company outsourcing the best quality products locally, essentially envisioning the vision of 'Make In India'.</p>
		                            </div>
		                        </div>
