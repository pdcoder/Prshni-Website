...
{
    $id= $_POST['id'];
$sql3 = "UPDATE notice SET text='$id'";
$resul3 = $conn->query($sql3);
if($resul3){
$err2 = "Successfull updated text";
header("Refresh:1");
}
else
...
<head>
    ...
    <title>Notification Slider images</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Notification Slider</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<br>
<input class="form-control" name="id" placeholder="Enter new text" type="text" required>
<br>
<input type="submit" value="Update" class="btn btn-success" name="submit2" >
